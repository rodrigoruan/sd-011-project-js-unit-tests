...
function getPrice(menu, item) {
  let foodPrice = menu.food[item];
  if (foodPrice !== undefined) return foodPrice;
  let drinkPrice = menu.drink[item];
  if (drinkPrice !== undefined) return drinkPrice;
  return 0.0;
}
