...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  it('Verifica se a função `numbers`retorna um array e se o array retornado contém somente números', () => {
    ...
    assert.strictEqual(numeros([1, 2, 3, 4, 5]), true);
    assert.strictEqual(numeros([1, 2, '3', 4, 5]), false)
    assert.strictEqual(numeros([1, 'a', 3]), false)
    assert.strictEqual(numeros([' ']), false)
  });
});
