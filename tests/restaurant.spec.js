...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const calledMenu = createMenu({ food: {}, drink: {} }).fetchMenu();
    assert.deepStrictEqual(Object.keys(calledMenu), ['food', 'drink']);

    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.fetchMenu() // Retorno: objetoQualquer

    const testThree = createMenu({ food: 'teste3', drink: 'teste3' });
    assert.deepStrictEqual(testThree.fetchMenu(), { food: 'teste3', drink: 'teste3' });
    ...
    objetoRetornado2 = createMenu('teste5');
    ...
    assert.deepStrictEqual(objetoRetornado5.pay(), 18.48);
  });
});
