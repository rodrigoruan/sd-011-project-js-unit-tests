...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // 
    const parametro = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    let objetoRetornado = createMenu(parametro);
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), parametro);
    ...
    // 
    objetoRetornado = createMenu(parametro);
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
