...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const objetoQualquer = {food: {coxinha: 3.90, sanduiche: 9.90, sopa: 10.90, sashimi: 20.90}, drinks: {agua: 3.90, cerveja: 6.90}};
    // ```
    ...
    // ```
    assert.strictEqual(objetoRetornado.pay(), '56.4');
