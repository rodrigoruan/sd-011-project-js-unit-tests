...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    keys = { food: {}, drink: {} };
    output = ['food', 'drink'];
    assert.deepStrictEqual(Object.keys(createMenu(keys).fetchMenu()), output);
    ...
    // ```
    keys = { food: { coxinha: 3.9 }, drink: { agua: 3.9 } };
    assert.deepStrictEqual(createMenu(keys).fetchMenu(), keys);
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.fetchMenu() // Retorno: objetoQualquer
    // ```
    let test = createMenu(keys);
    ...
    test.order('sopa');
    output = ['sopa'];
    assert.deepStrictEqual((test.consumption), output);
    // --------------------------------------------------------------------------------------
    ...
    test = createMenu(keys);
    orders(['coxinha', 'agua', 'sopa', 'cerveja'], test);
    output = ['coxinha', 'agua', 'sopa', 'cerveja'];
    assert.deepStrictEqual((test.consumption), output);
    // --------------------------------------------------------------------------------------
    ...
    test = createMenu(keys);
    orders(['coxinha', 'agua', 'cerveja'], test);
    output = ['coxinha', 'agua', 'cerveja'];
    assert.deepStrictEqual((test.consumption), output);
    // --------------------------------------------------------------------------------------
    ...
    output = 8.58;
    assert.strictEqual((test.pay()), output);
  });
});
