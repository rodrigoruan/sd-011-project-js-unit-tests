...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    // console.table(objetoRetornado);
    assert.strictEqual(objetoRetornado.pay(), objetoRetornado.fetchMenu().food['coxinha'] +
    objetoRetornado.fetchMenu().drink['agua'] + objetoRetornado.fetchMenu().food['coxinha']);
