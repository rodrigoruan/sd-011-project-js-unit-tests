...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const keys = [`food`, `drink`];
    const menu = createMenu(obj);
    const objectReturn = menu.fetchMenu();
    assert.deepStrictEqual(Object.keys(objectReturn), keys);
    ...
    assert.deepStrictEqual(objectReturn, { food: {}, drink: {} });
    // --------------------------------------------------------------------------------------
    ...
    menu.fetchMenu().food['coxinha'] = 2.5;
    menu.fetchMenu().drink['agua'] = 2;
    assert.strictEqual(menu.pay(), 7.7);
  });
});
