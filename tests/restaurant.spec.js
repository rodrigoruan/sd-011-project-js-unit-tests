...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    let output = createMenu();
    assert.strictEqual(typeof output, 'object');
    assert.strictEqual(typeof output.fetchMenu, 'function');
    ...
    // ```
    let param = { food: {}, drink: {}};
    output = createMenu(param);
    assert.deepStrictEqual(output.fetchMenu(), { food: {}, drink: {} });
    let keys = Object.keys(output.fetchMenu());
    ...
    // ```
    assert.deepStrictEqual(output.fetchMenu(), param);
    ...
    assert.strictEqual(output.consumption.includes('coxinha'), true);
    ...
    assert.strictEqual(output.consumption.length, 4);
    ...
    // ```
    param = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    output = createMenu(param);
    output.order('coxinha');
    output.order('agua');
    output.order('coxinha');
    ...
    // ```
    assert.strictEqual(output.pay(), 11.70);
