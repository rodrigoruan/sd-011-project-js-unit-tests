...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    let testeMenu = createMenu({food: {}, drink: {}});
    assert.deepStrictEqual(testeMenu.fetchMenu(), {food: {}, drink: {}});
    ...
    assert.deepStrictEqual(testeMenu.consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    testeMenu = createMenu(cardapio);
    testeMenu.order('coxinha');
    assert.strictEqual(testeMenu.consumption.includes('coxinha'), true)
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    testeMenu.order("sopa");
    testeMenu.order("sashimi");
    // objetoRetornado.consumption // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    assert.deepStrictEqual(testeMenu.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    testeMenu.order('agua');
    testeMenu.order('coxinha');
    //testeMenu1.comsuption // Retorno: ['coxinha', 'agua', 'coxinha']
    assert.deepStrictEqual(testeMenu.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    assert.deepStrictEqual(testeMenu.pay(), '12.87');
