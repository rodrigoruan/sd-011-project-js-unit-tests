...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(productDetails('a', 'b')[0].details.productId.includes(`${'a'}123`), true);
    assert.strictEqual(productDetails('a', 'b')[1].details.productId.includes(`${'b'}123`), true);
