...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(typeof Object.keys(productDetails('Alcool gel', 'Máscara')[0]), 'object')
    assert.strictEqual(typeof Object.keys(productDetails('Alcool gel', 'Máscara')[1]), 'object')
