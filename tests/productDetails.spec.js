...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.strictEqual((Object.values(productDetails('alcool', 'mascara'))[0].details.productId).slice(-3), "123");
    assert.strictEqual((Object.values(productDetails('alcool', 'mascara'))[1].details.productId).slice(-3), "123")
  });
});
