...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // ESCREVA SEUS TESTES ABAIXO (atentar-se aos elementos CHILD):
    // Teste se circle retorna um objeto. Precisa incluir um parâmetro válido, caso contrário retorna o undefined.
    assert.strictEqual(typeof circle(1), 'object');
    // Teste se o objeto retornado tem 3 entradas. O length garante que retorne a quantidade 3 e não apenas as três keys em um array.
